- [1. Kubectl `apply`](#1-kubectl-apply)
  - [1.1. What is the difference between `apply` and `create`? X](#11-what-is-the-difference-between-apply-and-create-x)
...
- [2. Deployments](#2-deployments)
  - [2.1. Scale a deployment X](#21-scale-a-deployment-x)
  ...
  - [2.3. Blue-green deployment basics](#23-blue-green-deployment-basics)
    - [2.3.1. How do you setup a blue-green deployment X](#231-how-do-you-setup-a-blue-green-deployment-x)
  - [2.4. How can I see how my `local file` is different from `live object`? X](#24-how-can-i-see-how-my-local-file-is-different-from-live-object-x)
...
- [Jobs](#jobs)
  - [How do you define if a job should restart on fail?](#how-do-you-define-if-a-job-should-restart-on-fail)
- [Cronjob](#cronjob)
...
## 1.1. What is the difference between `apply` and `create`? X
...
### 2.3.1. How do you setup a blue-green deployment X
...
## 2.4. How can I see how my `local file` is different from `live object`? X
...
## How do you define if a job should restart on fail?
